...
`pcn create` directive does, you can look at the file `pcn_create.ado`, but it
general it makes sure to load the data in the P drive and standardize the output
to make it ready for PovcalNet. For instance, it replace zeros and missing
values of the welfare and weight variables like this,
