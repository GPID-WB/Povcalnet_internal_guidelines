...
`wbopendata`. For GDP the indicator is `NY.GDP.PCAP.KD` (GDP per capita (constant 2010 US$)) and for PCE the indicator used
is `NE.CON.PRVT.PC.KD` (Households Final Consumption Expenditure per capita (constant 2010 US$)). For some countries, however, the economic growth data is
