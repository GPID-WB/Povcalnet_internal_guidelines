...
```{r GKnodes, echo=FALSE, fig.cap = ""} 
knitr::include_graphics("images/samuel/go_to_repo.PNG") 
```
...
```{r GKnodes, echo=FALSE, fig.cap = ""} 
knitr::include_graphics("images/samuel/new_repo.PNG") 
```
...
```{r GKnodes, echo=FALSE, fig.cap = ""} 
knitr::include_graphics("images/samuel/initialize_v1.PNG") 
```
...
```{r GKnodes, echo=FALSE, fig.cap = ""} 
knitr::include_graphics("images/samuel/go_to_clone_repo.PNG") 
```
...
```{r GKnodes, echo=FALSE, fig.cap = ""} 
knitr::include_graphics("images/samuel/select_repo_to_be_cloned.PNG") 
```
...
```{r GKnodes, echo=FALSE, fig.cap = ""} 
knitr::include_graphics("images/samuel/select_repo_to_be_cloned_github.PNG") 
```  
(ii) Select the repository you want to clone from the list of repositories in your GitHub account.  

```{r GKnodes, echo=FALSE, fig.cap = ""} 
knitr::include_graphics("images/samuel/select_repo_to_be_cloned_github_repos.PNG") 
```

3. Specify the local directory for the new repository.  

```{r GKnodes, echo=FALSE, fig.cap = ""} 
knitr::include_graphics("images/samuel/select_local_directory.PNG") 
``` 
...
```{r GKnodes, echo=FALSE, fig.cap = ""} 
knitr::include_graphics("images/samuel/repos_to_organize.PNG") 
```
...
```{r GKnodes, echo=FALSE, fig.cap = ""} 
knitr::include_graphics("images/samuel/go_to_repo_add.PNG") 
``` 
...
```{r GKnodes, echo=FALSE, fig.cap = ""} 
knitr::include_graphics("images/samuel/version_control.PNG") 
``` 

3. Drag and drop repositories into the relevant group. 

```{r GKnodes, echo=FALSE, fig.cap = ""} 
knitr::include_graphics("images/samuel/drag_and_drop.PNG") 
```
...
```{r GKnodes, echo=FALSE, fig.cap = ""} 
knitr::include_graphics("images/samuel/new_repo_github.PNG") 
```

2. Enter name of repository, select Public or Private, and do **NOT** select Initialize.

```{r GKnodes, echo=FALSE, fig.cap = ""} 
knitr::include_graphics("images/samuel/do_not_select_initialize.PNG") 
```
...
```{r GKnodes, echo=FALSE, fig.cap = ""} 
knitr::include_graphics("images/samuel/dofiles_for_github.PNG") 
```

5. Select Initialize.

```{r GKnodes, echo=FALSE, fig.cap = ""} 
knitr::include_graphics("images/samuel/initialize_v2.PNG") 
```

6. Go to **Local** | **Stage**.

```{r GKnodes, echo=FALSE, fig.cap = ""} 
knitr::include_graphics("images/samuel/go_to_local_stage.PNG") 
```

7. Select Stage.

```{r GKnodes, echo=FALSE, fig.cap = ""} 
knitr::include_graphics("images/samuel/stage.PNG") 
```

8. Go to **Local** | **Commit**.

```{r GKnodes, echo=FALSE, fig.cap = ""} 
knitr::include_graphics("images/samuel/go_to_local_commit.PNG") 
```

9. Enter a commit message and hit Commit.

```{r GKnodes, echo=FALSE, fig.cap = ""} 
knitr::include_graphics("images/samuel/enter_commit_message.PNG") 
```

10. Go to **Remote** | **Add**.

```{r GKnodes, echo=FALSE, fig.cap = ""} 
knitr::include_graphics("images/samuel/go_to_remote_add.PNG") 
```

11. Select the new GitHub repository that you created in Step 1.

```{r GKnodes, echo=FALSE, fig.cap = ""} 
knitr::include_graphics("images/samuel/add_url.PNG") 
```

```{r GKnodes, echo=FALSE, fig.cap = ""} 
knitr::include_graphics("images/samuel/github.PNG") 
```

12. Add the remote repository.

```{r GKnodes, echo=FALSE, fig.cap = ""} 
knitr::include_graphics("images/samuel/add_remote_repo.PNG") 
```

13. Select master branch and origin.

```{r GKnodes, echo=FALSE, fig.cap = ""} 
knitr::include_graphics("images/samuel/select_master_origin.PNG") 
```

14. Right-click repository you want to push to GitHub, go to **Push**.

```{r GKnodes, echo=FALSE, fig.cap = ""} 
knitr::include_graphics("images/samuel/right_click_repo.PNG") 
```

15. Select Push

```{r GKnodes, echo=FALSE, fig.cap = ""} 
knitr::include_graphics("images/samuel/push.PNG") 
```

16. Check if you have the repository on GitHub.

```{r GKnodes, echo=FALSE, fig.cap = ""} 
knitr::include_graphics("images/samuel/check_github.PNG") 
```
