...
knitr::include_graphics("images/go_to_repo.PNG") 
```
...
```{r GKnodes, echo=FALSE, fig.cap = ""} 
knitr::include_graphics("images/go_to_clone_repo.PNG") 
```
...
```{r GKnodes, echo=FALSE, fig.cap = ""} 
knitr::include_graphics("images/go_to_repo_add.PNG") 
``` 
...
```{r GKnodes, echo=FALSE, fig.cap = ""} 
knitr::include_graphics("images/go_to_local_stage.PNG") 
```
...
```{r GKnodes, echo=FALSE, fig.cap = ""} 
knitr::include_graphics("images/go_to_remote_add.PNG") 
```
