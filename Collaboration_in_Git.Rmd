...
2.	Download [GitKraken](https://www.gitkraken.com/git-client) and install it. You donât need admin permissions to install it, but do NOT download it in the "downloads" folder.   
