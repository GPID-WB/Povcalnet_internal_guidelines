...
An overview of Git commands... / the git workflow..     

```{r git_commands, echo=FALSE}
knitr::include_graphics("images/git-overview-of-commands.png") 
``` 

Picture source: [^git-overview-of-commands]. 
...
An issue must have a title and description of the topic to tackle, and usually has labels to help to categorize it, at least one assignee in charge of working on it, and a comment section where the team members can interact. An issue look something like this:
