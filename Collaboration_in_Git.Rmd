...
```{r toolbar1, echo=FALSE, fig.cap = "Toolbar"} 
knitr::include_graphics("images/Toolbar1.PNG") 
``` 
```{r toolbar2, echo=FALSE, fig.cap = "Customize menu"} 
knitr::include_graphics("images/Toolbar2.PNG") 
``` 
```{r toolbar3, echo=FALSE, fig.cap = "Add/delete commands"} 
...
```{r sg_stage, echo=FALSE, fig.cap = "Stage command"} 
...
```{r sg_commit, echo=FALSE, fig.cap = "Commit command"} 
...
```{r sg_push, echo=FALSE, fig.cap = "Push command"} 
knitr::include_graphics("images/SG_push.PNG") 
``` 
4. How to stage commit and push
First, let us take a look at the SmartGit interface.
```{r interface, echo=FALSE, fig.cap = "SmartGit Interface"} 
...
knitr::include_url("https://www.youtube.com/watch?v=wDM5sQX5lEU") 
``` 
 ...
 ```{r video3, echo=FALSE, fig.align="center", fig.cap = "Stage and commit a .do file"} 
knitr::include_url("https://www.youtube.com/watch?v=dOUheWAKx_U") 
``` 
...
``` 
```{r pull2, echo=FALSE, fig.cap = "Pull or fetch only"} 
...
```{r pull3, echo=FALSE, fig.cap = "Successful (rebase) pull"} 
...
```{r branch1, echo=FALSE, fig.cap = "Master Branch"} 
knitr::include_graphics("images/branch1.PNG") 
``` 
We now click on the icon
```{r sg_branch, echo=FALSE, fig.cap = "New Branch command"} 
knitr::include_graphics("images/SG_branch.PNG") 
``` 
SmartGit will ask you to give a name to your branch, in this case "MartaS" and click on "Add branch"
```{r branch2, echo=FALSE, fig.cap = "Add new branch"} 
...
```{r branch3, echo=FALSE, fig.cap = "Checkout a Branch"} 
...
```{r branch4, echo=FALSE, fig.cap = "Local Branch changed from master to MartaS"} 
